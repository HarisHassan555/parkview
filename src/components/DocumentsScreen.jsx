...
const DocumentsScreen = ({ onBackToUpload }) => {
  ...
  }, [documents, selectedMonth, selectedStatus]);
  ...
  const handleMonthlyDownload = async () => {
    try {
      ...
      await exportMonthlyDocumentsToExcel(documentsToExport, exportName, 'All Users');
    } catch (error) {
  ...
  const getMonthOptions = () => {
    ...
    // Add "All" option
    months.push({ value: 'all', label: 'All Documents' });
    
    // Add available months from documents
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  title={`Download ${selectedMonth === 'all' ? 'All Documents' : selectedMonth} Excel`}
                >
                  {isDownloading ? (
                ...
                <button
                  ...
                  title={activeExcelFile ? `Sync ${selectedMonth === 'all' ? 'All Documents' : selectedMonth} with uploaded Excel` : 'Upload an Excel file first'}
                >
                  {isSyncing ? (
                    <div className="animate-spin rounded-full h-5 w-5 border-b-2 border-blue-400"></div>
                  ) : (
              ...
              <div className="bg-gray-50 px-4 sm:px-6 py-4 border-b border-gray-200">
                <div className="grid grid-cols-12 gap-2 sm:gap-4 items-center min-w-[1000px]">
                  <div className="col-span-5 sm:col-span-3">
                    <h3 className="text-sm font-semibold text-gray-900 uppercase tracking-wider">Document</h3>
                  </div>
                  <div className="col-span-2 sm:col-span-1">
                    <h3 className="text-sm font-semibold text-gray-900 uppercase tracking-wider">User</h3>
                  </div>
                  <div className="col-span-3 sm:col-span-2">
                    <h3 className="text-sm font-semibold text-gray-900 uppercase tracking-wider">Account No.</h3>
                  </div>
                  <div className="col-span-0 sm:col-span-1 hidden sm:block">
                    <h3 className="text-sm font-semibold text-gray-900 uppercase tracking-wider">Amount</h3>
                  </div>
                  <div className="col-span-0 sm:col-span-2 hidden sm:block">
                    <h3 className="text-sm font-semibold text-gray-900 uppercase tracking-wider">Uploaded</h3>
                  </div>
                  ...
                  >
                    ...
                    <div className="sm:hidden">
                      ...
                      <div className="grid grid-cols-2 gap-4 text-sm">
                        <div>
                          ...
                          <div className="text-gray-900">{getUserName(document.userId)}</div>
                        </div>
                        <div>
                    ...
                    <div className="hidden sm:block">
                      <div className="grid grid-cols-12 gap-2 sm:gap-4 items-center min-w-[1000px]">
                        ...
                        {/* User */}
                        <div className="col-span-2 sm:col-span-1">
                          <div className="text-sm text-gray-900">{getUserName(document.userId)}</div>
                          <div className="text-xs text-gray-500">User</div>
                        </div>

                        {/* Account No. */}
                        <div className="col-span-3 sm:col-span-2">
                          <div className="text-sm text-gray-900 break-all">{getAccountOrPhone(document)}</div>
