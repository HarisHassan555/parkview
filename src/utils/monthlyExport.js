  ...
  const excelData = documents.map((doc, index) => {
    ...
    if (doc.documentType === 'mobile_payment' && doc.extractedData) {
      ...
      return {
        ...
        'Transaction Date': paymentData.date || 'N/A',
        'Transaction Time': paymentData.time || 'N/A',
        'Sender Name': paymentData.fromName || 'N/A',
        'Sender Phone': paymentData.fromPhone || 'N/A',
        'Sender Account': paymentData.fromAccount || 'N/A',
        'Receiver Name': paymentData.toName || 'N/A',
        'Receiver Phone': paymentData.toPhone || 'N/A',
        'Receiver Account': paymentData.toAccount || 'N/A',
